...
@property(nonatomic, strong) NSDictionary *vContent;
//@property(nonatomic, strong) NSString *vContentSig;
//@property(nonatomic, strong) NSString *vContentInfo;
//@property(nonatomic, strong) NSString *vContentPath;
