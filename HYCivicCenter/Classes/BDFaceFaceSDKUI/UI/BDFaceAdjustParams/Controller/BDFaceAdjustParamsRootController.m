...
- (void)viewDidLoad {
    ...
    [self loadTitleView];
    CGRect tableViewRect = CGRectMake(0, CGRectGetMaxY(self.titleView.frame), [BDFaceCalculateTool screenWidth], [BDFaceCalculateTool screenHeight] - [BDFaceCalculateTool safeTopMargin] - BDFaceAdjustParamsNavigationBarHeight);
...
- (void)loadTitleView {
    ...
    CGRect titleRect = CGRectMake(0, originY, [BDFaceCalculateTool screenWidth], BDFaceAdjustParamsNavigationBarHeight);
