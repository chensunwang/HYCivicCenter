...
/// 3 获取身份认证数据
/// @param IdCardData CTIDReq对象：需包含 randomNumber、organizeID、appID、code、type
...
+(void)getLocalCtidWithUrlScheme:(NSString *)urlScheme appName:(NSString *)appName NS_DEPRECATED_IOS(2_0,13_0,"此函数已过期,请使用 getLocalCtidWithReq 函数") __TVOS_PROHIBITED;


///  10 在CTID APP中获取网证【新】
/// @param req CTIDReq对象：需包含urlScheme、organizeID、appID
+(NSDictionary *)getLocalCtidWithReq:(CTIDReq *)req;
