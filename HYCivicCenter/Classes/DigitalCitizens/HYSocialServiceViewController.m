//
//  HYSocialServiceViewController.m
//  HelloFrame
//
...
@implementation HYSocialServiceViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.titleView = [UILabel xf_labelWithText:@"社会服务"];
