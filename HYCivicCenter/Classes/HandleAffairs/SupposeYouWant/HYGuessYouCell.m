...
- (void)setupUI {
    ...
    [self.business1 setImage:HyBundleImage(@"guess01") forState:UIControlStateNormal];
    ...
    [self.business2 setImage:HyBundleImage(@"guess02") forState:UIControlStateNormal];
    ...
    [self.business3 setImage:HyBundleImage(@"guess03") forState:UIControlStateNormal];
