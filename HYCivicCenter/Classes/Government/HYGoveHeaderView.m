...
- (void)setupUI {
    ...
    self.headerImgV.image = HyBundleImage(@"icon_gove_home");
    ...
    self.trackImgV.image = HyBundleImage(@"icon_gove_percent");
    ...
    [self.moreButton setImage:HyBundleImage(@"icon_gov_more") forState:UIControlStateNormal];
